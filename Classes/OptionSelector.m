...
- (void)showNavigation {
	mLeftArrow = [SPImage imageWithContentsOfFile:@"left_arrow.png"];
	...
	mRightArrow = [SPImage imageWithContentsOfFile:@"right_arrow.png"];
...
- (void)createOption:(Option*)option x:(float)x y:(float)y {
	...
	SPSprite *optionSprite = [[SPSprite alloc] init];
